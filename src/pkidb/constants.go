...
var EnvironmentConfigMap = map[string]EnvConfig{
	...
	"PKIDB_GLOBAL_OCSP_SERVER_PRIVATE_KEY": EnvConfig{Section: "global", ConfigKey: "ocsp_server_private_key"},
	"PKIDB_GLOBAL_OCSP_SERVER_PUBLIC_KEY":  EnvConfig{Section: "global", ConfigKey: "ocsp_server_public_key"},
	"PKIDB_GLOBAL_OCSP_URI":                EnvConfig{Section: "global", ConfigKey: "ocsp_uri"},
